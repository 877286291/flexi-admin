...
public class SaTokenConfigure implements WebMvcConfigurer {
    ...
    public void addInterceptors(InterceptorRegistry registry) {
        ...
        registry.addInterceptor(new SaInterceptor(handle -> {
            ...
            SaRouter.match(SaHttpMethod.PUT).match("/sys/user/resetPassword",
                    r -> StpUtil.checkPermission("sys:user:update"));
            // 角色管理
            ...
            SaRouter.match(SaHttpMethod.PUT).match("/sys/role/assignMenu",
                    r -> StpUtil.checkPermission("sys:role:assignMenu"));
            // 菜单管理
            ...
            SaRouter.match(SaHttpMethod.GET).match("/sys/menu/menu/tree",
                    r -> StpUtil.checkPermission("sys:menu:query"));
            // 系统公告管理
